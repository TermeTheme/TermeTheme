...
__('متن ویژه -- همیار وردپرس', 'wpb_widget_domain'),

// Widget description
array( 'description' => __( 'برای قرار دادن کدهای خود از این افزونه استفاده کنید', 'wpb_widget_domain' ), )
);
}
...
<p>
<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'عنوان:' ); ?></label>
<input class="widefat" id="<?php echo $this->get_field_id( 'count' ); ?>" name="<?php echo $this->get_field_name( 'count' ); ?>" type="text" value="<?php echo $count; ?>"  />
</p>

<p>
  <label for="<?php echo $this->get_field_id( 'selectopt' ); ?>"><?php _e( 'متن:' ); ?></label>
