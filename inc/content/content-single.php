<div class="col-md-8 col-sm-12 col-xs-12">
  <div class="article_content">
      ...
      <?php if ((isset($terme_postmeta['share-display']) && !empty($terme_postmeta['share-display']) || $terme_options['post_share'] ) ) : ?>
        <div class="article_social">
          ...
          <?php if (isset($terme_options['tumblr_share']) && !empty($terme_options['tumblr_share']))  : ?>
            <li><a href="http://www.tumblr.com/share/link?url=<?php echo urlencode( get_permalink() ); ?>"  target="_blank"><i class="fa fa-tumblr" aria-hidden="true"></i></a></li>
          <?php endif; ?>
          </ul>
        </div><!-- article_social -->
      <?php endif; ?>
    ...
    <?php endif; ?>
    <?php terme_set_post_views(get_the_ID()); endwhile; endif; ?>
    <?php
     if ((isset($terme_postmeta['relatedpost-display']) && !empty($terme_postmeta['relatedpost-display']) || $terme_options['related_posts'] ) ) :
