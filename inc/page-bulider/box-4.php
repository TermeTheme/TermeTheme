    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="big_post horizontal">
          <ul>
            <li>
              <div class="thumb"><img src="<?php bloginfo('template_url'); ?>/assets/img/post-01-215-215.jpg" height="75" width="100" alt=""></div>
            ...
            <li>
              <div class="thumb"><img src="<?php bloginfo('template_url'); ?>/assets/img/post-02-215-215.jpg" height="75" width="100" alt=""></div>
