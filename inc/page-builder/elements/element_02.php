...
class Terme_Element_Two extends Terme_Page_Builder_Element {
    ...
    function __construct($id=0, $passed_array=array()) {
        ...
        $this->icon = get_template_directory_uri().'/assets/admin/images/element_02.png';
    ...
    public function get_empty_fields() {
        ...
        $fields = array(
                        array(
                            'field' => '<input type="hidden" data-name="terme_pb[0][class_name]" value="Terme_Element_Two">',
                        ),
                        array(
    ...
    public function get_filled_fields($id=0) {
        ...
        $fields = array(
                        array(
                            'field' => '<input type="hidden" name="terme_pb['.$id.'][class_name]" value="Terme_Element_Two">',
                        ),
                        array(
                            'label' => __('Box Title:', 'terme'),
