...
class Terme_Element_Five extends Terme_Page_Builder_Element {
    ...
    public function get_empty_fields() {
        ...
        $fields = array(
                        array(
                            'field' => '<input type="hidden" data-name="terme_pb[0][class_name]" value="Terme_Element_Five">',
                        ),
                        array(
    ...
    public function get_filled_fields($id=0) {
        ...
        $fields = array(
                        array(
                            'field' => '<input type="hidden" name="terme_pb['.$id.'][class_name]" value="Terme_Element_Five">',
                        ),
                        array(
                            'label' => __('Box Title:', 'terme'),
