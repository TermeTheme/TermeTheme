 ...
 * @version 1.0.0
 */
class Terme_Element_Five extends Terme_Page_Builder_Element {
    ...
    public function get_empty_fields() {
        ...
        $fields = array(
                        array(
                            'field' => '<input type="hidden" data-name="terme_pb['.$this->id.'][class_name]" value="Terme_Element_Five">',
                        ),
                        array(
    ...
    public function get_filled_fields($id=0) {
        ...
        $fields = array(
                        array(
                            'field' => '<input type="hidden" name="terme_pb['.$this->id.'][class_name]" value="Terme_Element_Five">',
                        ),
                        array(
                            'label' => __('Box Title:', 'terme'),
    ...
    public function get_frontend_output() {
        ...
        $first_post->the_post();
            ...
            $output .= '
                      ...
                      <li>
                      <div class="thumb"><a href="'.get_permalink().'" title="'.get_the_title().'">'.get_the_post_thumbnail(get_the_id(), 'element_05_thumb_01').'</a></div>
                      '.$lid.'
...
function test_function_05($elements) {
    $element = new Terme_Element_Five();
    $elements[] = $element->get_dashboard_output();
    return $elements;
}
add_filter( 'after_terme_page_builder_elements', 'test_function_05' );
